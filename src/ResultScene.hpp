...
private:
    ...
    void setupUI() {
        ...
        m_titleText.setPosition(sf::Vector2f(centerX - titleBounds.size.x / 2.0f, 40.0f));
        
        m_statsText.setFillColor(sf::Color::White);
        m_statsText.setPosition(sf::Vector2f(centerX - 200.0f, 200.0f));
        
        m_rankText.setStyle(sf::Text::Bold);
        m_rankText.setPosition(sf::Vector2f(centerX + 150.0f, 220.0f));
